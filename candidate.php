        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
            ...
            <div class="team-item">
              ...
              <div class="content">
                <h4 class="title"><a href="candidate-details.php">David Silva</a></h4>
                <h5 class="sub-title">Web Designer</h5>
                <div class="rating-box">
                  <i class="icofont-star"></i>
                  <i class="icofont-star"></i>
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
            ...
            <div class="team-item">
              ...
              <div class="content">
                <h4 class="title"><a href="candidate-details.php">Jason Holt</a></h4>
                <h5 class="sub-title">UI/UX Designer</h5>
                <div class="rating-box">
                  <i class="icofont-star"></i>
                  <i class="icofont-star"></i>
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
            ...
            <div class="team-item">
              ...
              <div class="content">
                <h4 class="title"><a href="candidate-details.php">Elnora Morton</a></h4>
                <h5 class="sub-title">App. Developer</h5>
                <div class="rating-box">
                  <i class="icofont-star"></i>
                  <i class="icofont-star"></i>
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
            ...
            <div class="team-item">
              ...
              <div class="content">
                <h4 class="title"><a href="candidate-details.php">Leona Spencer</a></h4>
                <h5 class="sub-title">UI/UX Designer</h5>
                <div class="rating-box">
                  <i class="icofont-star"></i>
                  <i class="icofont-star"></i>
