...
// include_once("add_pass_candidate.php");
            ...
            <div class="login-register-form-wrap register-form-wrap">
              <div class="login-register-form">
                ...
                <!-- <ul class="nav nav-pills" id="pills-tab" role="tablist"> -->
                  ...
                  <!-- <li class="nav-item" role="presentation">
                    <button class="nav-link " id="employer-tab" data-bs-toggle="pill" data-bs-target="#employer" type="button" role="tab" aria-controls="employer" aria-selected="true"><i class="icofont-bag-alt">employer</i> </button>
                  </li> -->
                <!-- </ul> -->
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group">
                            <input class="form-control" name ="email_1" type="email" placeholder="Email">
                          </div>
                        </div>
                        <div class="col-12">
                          <div class="form-group">
                            <input class="form-control" name = "password_1" type="password" placeholder="Password">
                          </div>
                        </div>
                        <div class="col-12">
                          <div class="form-group">
                            <input class="form-control" name="confirmation_1" type="password" placeholder="Confirm Password">
                          </div>
                        </div>
                        <div class="col-12">
                          <div class="form-group">
                            <div class="remember-forgot-info">
                              <div class="remember">
                                <input class="form-check-input" type="checkbox" value="1" id="defaultCheck1" name = "checkbox_1">
                        ...
                        <div class="col-12">
                          <div class="form-group">
                            <button type="button" name= "register" class="btn-theme">Register Now</button>
                          </div>
                        </div>
                      </div>
                    </form>
                      ...
                      <div class="row">
                        ...
                        <div class="col-12">
                          <div class="form-group">
                            <div class="remember-forgot-info">
                              <!-- <div class="remember">
                                <input class="form-check-input" type="checkbox" value="" id="defaultCheck1" name ="checkbox_2">
                                <label class="form-check-label" for="defaultCheck1">Accept our terms and conditions and privacy policy.</label>
                              </div> -->
                            </div>
                          </div>
